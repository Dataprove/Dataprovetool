...
The paper (long version) about the theoretical background of the tool can be read here: ![alt text](https://github.com/Dataprove/Dataprovetool/blob/main/Pictures%20for%20user%20manual/features.png).
